...
public partial class OverworldItem() : RigidBody3D
{
    ...
    public void LaunchFromPlayer()
    {
        ...
        Vector3 startPosition = new Vector3(Player.GlobalPosition.X, Player.GlobalPosition.Y + 1, Player.GlobalPosition.Z);
    ...
    private void OnBodyEntered(Node collideWithObject)
    {
        // TODO: This needs to be reworked once I add walls. This will give a false positive after hitting a wall
