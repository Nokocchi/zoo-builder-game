...
public class GlobalDataSingleton
{
    ...
    public static readonly string SETTINGS_LOCATION = "user://settings3.json";
    ...
    public static float BackgroundMusicAudioVolume => Instance.FloatSettings[KEY_BACKGROUND_MUSIC_AUDIO_VOLUME];
    public static string SelectedLocale => Instance.StringSettings[KEY_SELECTED_LOCALE];
