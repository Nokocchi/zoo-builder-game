...
{
	private static readonly PackedScene LanguageSelectorInputScene = GD.Load<PackedScene>("res://src/ui/ingamemenu/settings/input/language_selector_input.tscn");
	...
	public void RestoreDefault()
	{
		...
		{
			string locale = (string)GetItemMetadata(i);
